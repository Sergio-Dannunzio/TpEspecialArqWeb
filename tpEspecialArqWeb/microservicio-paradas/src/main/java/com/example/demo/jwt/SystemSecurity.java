...
public class SystemSecurity {
    ...
    private static final List<String> allowed = List.of("MaintenanceService", "AdminService", "AccountService", "ParadaService", "MonopatinService");

    private static String key = "Parada";
